...
<!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/11-06-2021/electronics-mart-liberty-demo_Free/1081434887/web/help.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Oct 2022 17:31:07 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
	<title>Electronics Mart - Ecommerce Category Bootstrap Responsive Web Template | Help :: w3layouts</title>
	<!-- Required meta tags -->
	<meta charset="utf-8">
			...
			<div class="wthree-help mb-sm-5 mb-4">
				<div class="agile-left-help">
					...
					<form action="#" method="get">
						<textarea placeholder="Type keywords to find answers" name="Message" required=""></textarea>
						<button class="btn btn-style mt-4">Submit Now</button>
					</form>
					<h5 class="my-sm-4 my-3">OR</h5>
					<a class="btn btn-style btn-style-secondary" href="contact.html">Contact Us</a>
				</div>
			</div>
			<!-- //help content -->
			<!-- Faqs -->
