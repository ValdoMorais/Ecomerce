...
<!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/11-06-2021/electronics-mart-liberty-demo_Free/1081434887/web/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Oct 2022 17:30:42 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
	<title>Electronics Mart - Ecommerce Category Bootstrap Responsive Web Template | About Us :: w3layouts</title>
	<!-- Required meta tags -->
	<meta charset="utf-8">
			...
			<div class="row align-items-center justify-content-between">
				<div class="col-lg-6 about-2-secs-left pr-lg-5">
					...
					<ul class="list-about-2 list-unstyled mt-sm-4 mt-3">
						<li class="py-1"><i class="fas fa-check-square mr-2"></i>Ut enim ad minim
							veniam</li>
						<li class="py-2"><i class="fas fa-check-square mr-2"></i>Quis nostrud
							exercitation ullamco laboris</li>
						<li class="py-1"><i class="fas fa-check-square mr-2"></i>Nisi ut aliquip ex
							ea commodo consequat</li>
					</ul>
					<div class="mt-4">
						<a class="btn btn-style" href="product2.html">View Our Products</a>
					</div>
				</div>
...
<!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/11-06-2021/electronics-mart-liberty-demo_Free/1081434887/web/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Oct 2022 17:30:44 GMT -->
</html>