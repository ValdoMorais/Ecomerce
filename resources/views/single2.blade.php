...
<!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/11-06-2021/electronics-mart-liberty-demo_Free/1081434887/web/single2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Oct 2022 17:31:03 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
	<title>Electronics Mart - Ecommerce Category Bootstrap Responsive Web Template | Product Single 2 :: w3layouts</title>
	<!-- Required meta tags -->
	<meta charset="utf-8">
		...
		<div class="container py-md-5 py-4">
			<div class="row">
							...
							<ul class="slides">
								<li data-thumb="images/sii1.png">
									<div class="thumb-image">
										<img src="images/sii1.png" data-imagezoom="true" class="img-fluid" alt="">
									</div>
								</li>
								<li data-thumb="images/sii2.png">
									<div class="thumb-image">
										<img src="images/sii2.png" data-imagezoom="true" class="img-fluid" alt="">
									</div>
								</li>
								<li data-thumb="images/sii3.png">
									<div class="thumb-image">
										<img src="images/sii3.png" data-imagezoom="true" class="img-fluid" alt="">
									</div>
								</li>
							</ul>
							<div class="clearfix"></div>
				...
				<div class="col-lg-7 single-right-left simpleCart_shelfItem">
					<h3 class="mb-3">Whirlpool 245 L Frost Free Double Door 2 Star Refrigerator</h3>
					<p class="mb-3">
						<span class="item_price">$400.00</span>
						<del class="mx-2 font-weight-light">$500.00</del>
					...
					<div class="product-single-w3l">
						...
						<ul>
							<li class="mb-1">
								Refrigerator, User Manual, Warranty Card
							</li>
							<li class="mb-1">
							...
							<li class="mb-1">
								1 Year on Product and 10 Years on Compressor From Whirlpool
							</li>
						</ul>
...
<!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/11-06-2021/electronics-mart-liberty-demo_Free/1081434887/web/single2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Oct 2022 17:31:04 GMT -->
</html>