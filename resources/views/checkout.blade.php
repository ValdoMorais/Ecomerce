...
<!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/11-06-2021/electronics-mart-liberty-demo_Free/1081434887/web/checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Oct 2022 17:30:33 GMT -->
		...
		<div class="container py-md-5 py-4">
						...
						<tbody>
							<tr class="rem1">
								...
								<td class="invert-image">
									<a href="single.html">
										<img src="images/k1.png" alt=" " class="img-responsive">
									</a>
								</td>
								<td class="invert">
									<div class="quantity">
							...
							<tr class="rem2">
								...
								<td class="invert-image">
									<a href="single2.html">
										<img src="images/k2.png" alt=" " class="img-responsive">
									</a>
								</td>
								<td class="invert">
									<div class="quantity">
							...
							<tr class="rem3">
								...
								<td class="invert-image">
									<a href="single.html">
										<img src="images/k4.png" alt=" " class="img-responsive">
									</a>
								</td>
								<td class="invert">
									<div class="quantity">
			...
			<div class="checkout-left">
				<div class="address_form_agile mt-sm-5 mt-4">
					...
					<form action="https://demo.w3layouts.com/demos_new/template_demo/11-06-2021/electronics-mart-liberty-demo_Free/1081434887/web/payment.html" method="post" class="creditly-card-form agileinfo_form">
