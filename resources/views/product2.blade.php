...
<!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/11-06-2021/electronics-mart-liberty-demo_Free/1081434887/web/product2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Oct 2022 17:30:39 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
	<title>Electronics Mart - Ecommerce Category Bootstrap Responsive Web Template | Product 2 :: w3layouts</title>
	<!-- Required meta tags -->
	<meta charset="utf-8">
...
<div class="bs-example bs-example-tabs right-sidebar-tab-notification" data-example-id="togglable-tabs">
    ...
    <div id="w3lDemoBar" class="w3l-demo-bar">
        <div class="demo-btns">
        <a href="https://w3layouts.com/?p=4763800000056326">
        ...
        <a href="https://w3layouts.com/checkout/?add-to-cart=4763800000056326" class="no-margin-bottom-mobile">
	...
	<div class="page-head_agile_info_w3l page-head_agile_info_w3l-2">
		<div class="container py-5">
			<h3 class="title-style pt-5">The Home <span>Appliances</span> Store</h3>
							...
							<div class="row">
								...
								<div class="col-md-4 product-men">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center mt-2">
											<h4 class="pt-1">
												<a href="single2.html">Smart AC with Wi-fi</a>
											</h4>
											<div class="info-product-price">
								...
								<div class="col-md-4 product-men">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center mt-2">
											<h4 class="pt-1">
												<a href="single2.html">Microwave Oven</a>
											</h4>
											<div class="info-product-price">
												<span class="item_price">$399.00</span>
												<del>$499.00</del>
											</div>
											<div
												class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
							...
							<div class="row">
								<div class="col-md-4 product-men">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center mt-2">
											<h4 class="pt-1">
												<a href="single2.html">Desert Air Cooler</a>
											</h4>
											<div class="info-product-price">
								...
								<div class="col-md-4 product-men mt-md-0 mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										...
										<div class="item-info-product text-center mt-2">
											<h4 class="pt-1">
												<a href="single2.html">Water Purifier</a>
											</h4>
											<div class="info-product-price">
						...
						<div class="product-sec1 px-lg-4 mb-5">
							<div class="row">
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="images/mk13.png" alt="" class="img-fluid">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single2.html" class="link-product-add-cart">Quick View</a>
												</div>
										...
										<div class="item-info-product text-center mt-2">
											<h4 class="pt-1">
												<a href="single2.html">Pigeon Electric Kettle</a>
											</h4>
											<div class="info-product-price">
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="images/mk14.png" alt="" class="img-fluid">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single2.html" class="link-product-add-cart">Quick View</a>
												</div>
										...
										<div class="item-info-product text-center mt-2">
											<h4 class="pt-1">
												<a href="single2.html">Dry Iron Nova</a>
											</h4>
											<div class="info-product-price">
											...
											<div
												...
												<form action="#" method="post">
													<fieldset>
														...
														<input type="hidden" name="add" value="1" />
														<input type="hidden" name="business" value=" " />
														<input type="hidden" name="item_name" value="Dry Iron Nova" />
								...
								<div class="col-md-4 product-men mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="images/mk15.png" alt="" class="img-fluid">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single2.html" class="link-product-add-cart">Quick View</a>
												</div>
										...
										<div class="item-info-product text-center mt-2">
											<h4 class="pt-1">
												<a href="single2.html">Mixer Grinder</a>
											</h4>
											<div class="info-product-price">
												<span class="item_price">$499.00</span>
												<del>$599.00</del>
											...
											<div
												...
												<form action="#" method="post">
													<fieldset>
														...
														<input type="hidden" name="add" value="1" />
														<input type="hidden" name="business" value=" " />
														<input type="hidden" name="item_name" value="Mixer Grinder" />
														<input type="hidden" name="amount" value="499.00" />
														<input type="hidden" name="discount_amount" value="1.00" />
														<input type="hidden" name="currency_code" value="USD" />
														<input type="hidden" name="return" value=" " />
						...
						<div class="product-sec1 px-lg-4 mt-5">
							<div class="row">
								<div class="col-md-4 product-men">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="images/mk16.png" alt="" class="img-fluid">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single2.html" class="link-product-add-cart">Quick View</a>
												</div>
										...
										<div class="item-info-product text-center mt-2">
											<h4 class="pt-1">
												<a href="single2.html">Smart Watch Bands</a>
											</h4>
											<div class="info-product-price">
												<span class="item_price">$299.00</span>
												<del>$399.00</del>
								...
								<div class="col-md-4 product-men mt-md-0 mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="images/mk17.png" alt="" class="img-fluid">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single2.html" class="link-product-add-cart">Quick View</a>
												</div>
										...
										<div class="item-info-product text-center mt-2">
											<h4 class="pt-1">
												<a href="single2.html">Hair Dryer Philips</a>
											</h4>
											<div class="info-product-price">
												<span class="item_price">$269.00</span>
												<del>$399.00</del>
											</div>
											<div
												class="snipcart-details top_brand_home_details item_add single-item hvr-outline-out">
								...
								<div class="col-md-4 product-men mt-md-0 mt-5">
									<div class="men-pro-item simpleCart_shelfItem">
										<div class="men-thumb-item text-center">
											<img src="images/mk18.png" alt="" class="img-fluid">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single2.html" class="link-product-add-cart">Quick View</a>
												</div>
										...
										<div class="item-info-product text-center mt-2">
											<h4 class="pt-1">
												<a href="single2.html">Induction Cooktop</a>
											</h4>
											<div class="info-product-price">
												<span class="item_price">$499.00</span>
												<del>$699.00</del>
...
<!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/11-06-2021/electronics-mart-liberty-demo_Free/1081434887/web/product2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Oct 2022 17:30:42 GMT -->
</html>