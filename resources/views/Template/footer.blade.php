        ...
        <div class="row footer-info w3-agileits-info">
            ...
            <div class="col-md-3 col-sm-6 footer-grids">
                ...
                <ul>
                    ...
                    <li class="mb-3">
                        <a href="product2">Smartphones</a>
                    </li>
                    <li class="mb-3">
                        <a href="product">Washing Machines</a>
                    </li>
                    <li>
                        <a href="product2">Refrigerators</a>
                    </li>
                </ul>
            </div>
            <!-- //footer categories -->
            ...
            <div class="col-md-3 col-sm-6 footer-grids mt-md-0 mt-4">
                ...
                <ul>
                    <li class="mb-3">
                        <i class="fas fa-map-marker"></i> Macurrungo, Beira, Mozambique.</li>
                    <li class="mb-3">
                        <i class="fas fa-mobile"></i><a href="#"> +258 846 7777 76</a> </li>
                    <li class="mb-3">
                        <i class="fas fa-phone"></i><a href="#">+258 871 3820 01</a> </li>
                    <li class="mb-3">
                        <i class="fas fa-envelope-open"></i>
                        <a href="mailto:example@mail.com"> mail 1 valdomorais.vm@gmail.com</a>
                    </li>
                    <li>
                        <i class="fas fa-envelope-open"></i>
                        <a href="mailto:example@mail.com"> mail 2 valdoflor01@gamil.com</a>
                    </li>
                </ul>
            </div>
    ...
    <div class="container">
        ...
        <div class="sub-some mt-4">
            ...
            <ul>
                ...
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">Data Cards</a>
                </li>
            </ul>
        </div>
        <div class="sub-some mt-4">
            ...
            <ul>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">TVs & DTH</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">Home Theatre Systems</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">Hidden Cameras & CCTVs</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">Refrigerators</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">Washing Machines</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2"> Air Conditioners</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">Cameras</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">Speakers</a>
                </li>
            </ul>
        </div>
        <div class="sub-some mt-4">
            ...
            <ul>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">Headphones</a>
                </li>
                <li class="m-sm-1">
                ...
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">External Hard Disks</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2"> Mouse</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">Smart Watches & Fitness Bands</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">MicroSD Cards</a>
                </li>
            </ul>
        </div>
        <div class="sub-some mt-4">
            ...
            <ul>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">Trimmers</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">Hair Dryers</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">Emergency Lights</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">Water Purifiers </a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">Electric Kettles</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">Hair Straighteners</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">Induction Cooktops</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">Sewing Machines</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2"> Geysers</a>
                </li>
            </ul>
        </div>
        <div class="sub-some mt-4">
            ...
            <ul>
                ...
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">Couple Watches</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">Gas Stoves</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2"> Air Coolers</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">Air Purifiers</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">Headphones</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2"> Headsets</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">Pressure Cookers</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">Sandwich Makers</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">Air Friers</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">Irons</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">LED TV</a>
                </li>
                <li class="m-sm-1">
                    <a href="product2" class="border-right pr-2">Sandwich Makers</a>
                </li>
...
<div class="copy-right py-3">
    <div class="container">
        <p class="text-center ">© 2022 Electronics Mart. All rights reserved | Design by
            <a href="#"> Valdo Morais Flor.</a>
        </p>
    </div>
</div>
<!-- //copyright -->
