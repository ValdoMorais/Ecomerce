...
<!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/11-06-2021/electronics-mart-liberty-demo_Free/1081434887/web/payment.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Oct 2022 17:31:04 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
	<title>Electronics Mart - Ecommerce Category Bootstrap Responsive Web Template </title>
	<!-- Required meta tags -->
	<meta charset="utf-8">
			...
			<nav class="navbar navbar-expand-lg navbar-light">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav text-center ml-auto">
						...
						<li class="nav-item active dropdown mr-lg-2 mb-lg-0 mb-2">
							<a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown"
								aria-haspopup="true" aria-expanded="false">
								Pages
							</a>
							...
							<form action="#" method="post" class="creditly-card-form agileinfo_form">
								<div class="creditly-wrapper wthree, w3_agileits_wrapper">
									<div class="credit-card-wrapper">
										...
										<button class="submit mt-3"><span>Make a Payment</span></button>
									</div>
								</div>
							</form>
						</div>
						<div>
							<div class="vertical_post">
								<form action="#" method="post">
									...
									<button type="submit" class="btn btn-style mt-4">Pay Now</button>
								</form>
							</div>
						</div>
						<div>
												...
												<div class="credit-card-wrapper">
													<div class="first-row form-group">
														...
														<div class="paymntf_card_number_grids">
															...
															<div class="fpay_card_number_grid_right mt-3">
																<div class="controls">
																	<label class="control-label">CVV</label>
...
<!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/11-06-2021/electronics-mart-liberty-demo_Free/1081434887/web/payment.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Oct 2022 17:31:07 GMT -->
</html>